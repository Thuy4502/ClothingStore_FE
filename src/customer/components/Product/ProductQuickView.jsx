                  ...
                  <section aria-labelledby="information-heading" className="mt-2">
                    ...
                    <div className="mt-6">
                      ...
                      <div className="flex items-center">
                          ...
                          {[0, 1, 2, 3, 4].map((rating) => (
                            <StarIcon
                              ...
                              className={classNames(
                                product.rating > rating ? 'text-[#ffe79a]' : 'text-gray-200',
                        ...
                        <a href="#" className="ml-3 text-sm font-medium text-[#ea8a8a] hover:text-[#ff9776]">
                          ...
                          {product.sizes.map((size) => (
                            ...
                            >
                              ...
                              {size.inStock ? (
                                <span
                                  aria-hidden="true"
                                  className="pointer-events-none absolute -inset-px rounded-md border-2 border-transparent group-data-[focus]:border group-data-[checked]:border-[#233142]"
                                />
                              ) : (
                                <span
                                  aria-hidden="true"
