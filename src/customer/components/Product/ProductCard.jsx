...
const ProductCard = ({product}) => {
  ...
  return (
    <div onClick={()=>navigate(`/product/${product.productId}`)} className='productCard w-[15rem] m-3 transition-all cursor-pointer'>
      ...
      <div className='textPart bg-white p-3 text-left'>
        ...
        <div className='flex items-center space-x-2'>
          ...
          <p className='line-through opacity-50'> $20</p>
